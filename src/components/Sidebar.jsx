...
const Sidebar = () => {
  ...
  const activeLink =
    "flex itemx-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m2";
  const normalLink =
    "flex itemx-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m2";
